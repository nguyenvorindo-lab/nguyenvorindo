...
const ARTICLES = [
  ...
  },
  {
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwFdC2xhrnJafjUmuTIDgPq5BVDhR_cfqnh8GR2BwhbdaxKxnWi83fffLi&s=10",
    date: "2026-06-10",
    author: "Minh Khuê",
    tags: ["bền vững", "đồ cũ", "cộng đồng"],
    readTime: 3,
    event: { date: "Đã diễn ra 07–08/06/2026", location: "Công viên trung tâm" },
    content: ["Sự kiện chợ phiên lần này thu hút số lượng khách tham dự đông hơn dự kiến, buộc ban tổ chức phải kéo dài thời gian mở cửa trong ngày thứ hai.", "Ngoài hoạt động đổi đồ, sự kiện còn có góc sửa chữa quần áo miễn phí, giúp kéo dài tuổi thọ trang phục cũ thay vì bỏ đi.", "Nhiều người tham gia chia sẻ đây là lần đầu họ thử hình thức mua sắm không dùng tiền mặt trực tiếp mà quy đổi qua điểm thưởng."]
  },
  {
    id: 9,
    category: "xu-huong",
    ...
    image: "https://image.phunuonline.com.vn/fckeditor/upload/2024/20240923/images/xu-huong-sac-mau-trang-phuc-_121727103959.jpg",
    date: "2026-07-02",
    author: "Lan Chi",
    tags: ["màu sắc", "mùa thu", "sàn diễn"],
    readTime: 3,
    featured: true,
    content: ["Không phải ngẫu nhiên mà gam màu đất nung xuất hiện ở gần một phần ba các bộ sưu tập mùa Thu năm nay — đây là gam màu vừa ấm áp vừa dễ phối, phù hợp với xu hướng quay về sự tối giản có cảm xúc.", "Trên đường phố, sắc terracotta thường được kết hợp với chất liệu da lộn và len thô để tăng cảm giác 'chạm' — một yếu tố ngày càng được người mặc chú trọng bên cạnh hình ảnh.", "Các chuyên gia dự đoán gam màu này sẽ còn kéo dài sang mùa lễ hội cuối năm, đặc biệt trong nhóm sản phẩm áo khoác và túi da."]
  },
  {
    id: 10,
    category: "xu-huong",
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDjM1HUqAXmgxReU8dquxfGSPdY3qCzfUcdev5eP3bPuKlXnJVgqoXCPqZ&s=10",
    date: "2026-06-27",
    author: "Thu Hà",
    tags: ["công sở", "dáng quần", "streetstyle"],
    readTime: 3,
    content: ["Không còn là lựa chọn 'chỉ hợp đi chơi', quần ống rộng đang len lỏi vào tủ đồ công sở nhờ cách phối cùng áo blazer form vừa và giày mũi nhọn.", "Nhiều thương hiệu công sở nội địa đã nhanh chóng ra mắt các phiên bản wide-leg bằng vải ít nhăn, đáp ứng nhu cầu di chuyển nhiều trong ngày.", "Điểm cộng của dáng quần này là khả năng che khuyết điểm vòng 3, vòng đùi — lý do khiến nó được yêu thích rộng rãi hơn quần suông truyền thống."]
  },
  {
    id: 11,
    category: "xu-huong",
    ...
    image: "https://kenh14cdn.com/k:thumb_w/600/fZWcsjiQcccccccccccc366AAdFBMf/Image/2013/5/son-do/ngoc-trinh-lo-mieng-dan-nguc-vi-vay-ren-b62e1/vong-chunky-choker-hot-trend-duoc-loat-sao-viet-yeu-thich.jpg",
    date: "2026-06-22",
    author: "Minh Khuê",
    tags: ["phụ kiện", "streetstyle"],
    readTime: 2,
    content: ["Xu hướng phụ kiện kích thước lớn tiếp tục là cách nhanh nhất để một set đồ tối giản trở nên có điểm nhấn, không cần thay đổi cả trang phục.", "Đặc biệt, giày đế bản lớn kết hợp cùng quần jeans ống suông đang là công thức phối đồ được lặp lại nhiều nhất trên các nền tảng mạng xã hội trong tháng qua."]
  },
  {
    id: 12,
    category: "xu-huong",
    ...
    image: "https://vietextile.com/wp-content/uploads/2025/03/Denim-wash-1024x629.jpg",
    date: "2026-06-14",
    author: "Đức Anh",
    tags: ["denim", "hoài niệm"],
    readTime: 3,
    content: ["Sau nhiều năm vắng bóng, denim loang màu acid wash bất ngờ quay lại nhờ làn sóng thời trang hoài niệm những năm 90 lan rộng trên mạng xã hội.", "Khác với bản gốc thường đi kèm dáng ôm, phiên bản hiện tại được cắt may theo dáng rộng, dễ mặc hơn với số đông.", "Nhiều cửa hàng đồ cũ ghi nhận lượng tìm mua áo khoác denim acid wash tăng rõ rệt trong tháng gần đây."]
  },
  {
    id: 13,
    category: "lam-dep",
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_5fisYjns5uI45Pr9YPXqnpB3YZin2XONLIkwbr97jX3C9sVi0VPOx_Q&s=10",
    date: "2026-07-03",
    author: "Lan Chi",
    tags: ["trang điểm", "chăm sóc da"],
    readTime: 3,
    featured: true,
    content: ["Phong cách trang điểm tôn da thật — với lớp nền mỏng, độ bóng nhẹ tự nhiên — tiếp tục được ưa chuộng nhờ cảm giác 'ít can thiệp' mà vẫn rạng rỡ.", "Bí quyết để đạt được hiệu ứng này không nằm ở kem nền, mà ở bước chăm sóc da trước đó: dưỡng ẩm đủ và không bỏ qua bước xịt khoáng cố định lớp nền.", "Các chuyên gia lưu ý phong cách này phù hợp nhất với da đã được cấp ẩm tốt; da quá khô nên ưu tiên kem nền có thêm dưỡng chất trước khi thử."]
  },
  {
    id: 14,
    category: "lam-dep",
    ...
    image: "https://bizweb.dktcdn.net/100/452/346/files/goi-dau-dung-cach-massage-da-dau-nhe-nhang.jpg?v=1756871500276",
    date: "2026-06-26",
    author: "Thu Hà",
    tags: ["chăm sóc tóc", "làm đẹp chậm"],
    readTime: 3,
    content: ["Xu hướng 'làm đẹp chậm' — ưu tiên sản phẩm ít thành phần, quy trình đơn giản — đang khiến nhiều người quay lại với các loại dầu thực vật quen thuộc như dầu dừa, dầu argan.", "Khác với sản phẩm công nghiệp, dầu nguyên chất cần thời gian ủ lâu hơn để thấy hiệu quả, nhưng được đánh giá lành tính hơn với tóc đã qua xử lý hóa chất.", "Chuyên gia khuyên chỉ nên dùng lượng nhỏ và tập trung vào phần ngọn tóc để tránh gây bết ở da đầu."]
  },
  {
    id: 15,
    category: "lam-dep",
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQp9-HbK5aEhMlLnd4DReANonbH-s52aTQ7CDJk7BmMPrS8V7iVp6-od1tJ&s=10",
    date: "2026-06-19",
    author: "Minh Khuê",
    tags: ["chăm sóc da", "chống nắng"],
    readTime: 2,
    content: ["Một trong những lý do khiến nhiều người bỏ qua việc dặm lại kem chống nắng giữa ngày là sợ làm trôi lớp trang điểm — và đây chính là vấn đề mà định dạng xịt được sinh ra để giải quyết.", "Dù tiện lợi, chuyên gia da liễu khuyến cáo cần xịt đủ lượng và xoa đều để đảm bảo độ che phủ, tránh xịt qua loa khiến hiệu quả chống nắng không đạt như công bố."]
  },
  {
    id: 16,
    category: "lam-dep",
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHKjQWkXFR11mO16u9J0VQMQAEosKmH6ixKvNhVQUr8CTO4uw3ir-IivI0&s=10",
    date: "2026-06-11",
    author: "Đức Anh",
    tags: ["chăm sóc da", "công nghệ mỹ phẩm"],
    readTime: 4,
    content: ["Sau giai đoạn tập trung vào việc 'tẩy sạch' bằng các hoạt chất mạnh, ngành mỹ phẩm đang chuyển hướng sang các sản phẩm hỗ trợ cân bằng hệ vi sinh tự nhiên trên da.", "Serum chứa lợi khuẩn hoặc hậu sinh học được quảng cáo giúp da giảm kích ứng và phục hồi hàng rào bảo vệ tốt hơn, đặc biệt với da nhạy cảm.", "Tuy nhiên, các bác sĩ da liễu lưu ý người dùng nên thử trên diện nhỏ trước và không nên kỳ vọng hiệu quả tức thì như các sản phẩm tẩy tế bào chết hóa học."]
  }
];

const SEED_COMMENTS = {
  1: [{ name: "Ngọc Anh", time: "2 giờ trước", text: "Ủng hộ hướng đi này, mong các thương hiệu khác cũng làm theo!", likes: 12 }, { name: "Hoàng Long", time: "5 giờ trước", text: "Giá tăng 8-10% cũng hợp lý, miễn chất lượng vẫn ổn.", likes: 4 }],
  9: [{ name: "Bích Trâm", time: "1 giờ trước", text: "Mình vừa mua một áo khoác màu này, đúng là dễ phối thật.", likes: 7 }],
  13: [{ name: "Thảo My", time: "3 giờ trước", text: "Bài viết hữu ích, mình sẽ thử đổi quy trình dưỡng da trước khi trang điểm.", likes: 9 }, { name: "Quang Huy", time: "hôm qua", text: "Da dầu có hợp với kiểu trang điểm này không nhỉ?", likes: 2 }]
};
